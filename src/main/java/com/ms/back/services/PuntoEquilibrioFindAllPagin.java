...
import com.ms.back.dao.PuntoEquilibrioFindAllPaginDAO;
import com.ms.back.model.Pagin;

public class PuntoEquilibrioFindAllPagin extends AbstractService {

	private PuntoEquilibrioFindAllPaginDAO dao = new PuntoEquilibrioFindAllPaginDAO();

	public PuntoEquilibrioFindAllPagin(EnvironmentVariables vars) {
		super(vars);
	}
